...
function wps_add_select_checkout_field( $checkout ) {
    ...
    echo '<h3>'.__('Entrega de producto').'</h3><p>Seleccione el departamento donde se le enviarán sus productos.</p>';
    woocommerce_form_field( 'lugarentrega', array(
    'type' => 'select',
    ...
    'options' => array(
        ...
        'Managua' => __( 'Managua', 'wps' ),
        'Masaya' => __( 'Masaya', 'wps' ),
        'León' => __( 'León', 'wps' ),
		'Granada' => __( 'Granada', 'wps' ),
		'Rivas' => __( 'Rivas', 'wps' ),
		'Estelí' => __( 'Estelí', 'wps' ),
		'Jinotega' => __( 'Jinotega', 'wps' ),
		'Chinandega' => __( 'Chinandega', 'wps' ),
		'Matagalpa' => __( 'Matagalpa', 'wps' ),
		'Carazo' => __( 'Carazo', 'wps' ),
		'Boaco' => __( 'Boaco', 'wps' )
        )
    ),
    $checkout->get_value( 'lugarentrega' ));
}
...
function wps_select_checkout_field_process() {
 ...
 if ($_POST['lugarentrega'] == "blank")
 wc_add_notice( '<strong>Por favor, seleccione un lugar de entrega</strong>', 'error' );
}
...
add_action('woocommerce_checkout_update_order_meta', 'wps_select_checkout_field_update_order_meta');
 ...
 function wps_select_checkout_field_update_order_meta( $order_id ) {
        ...
        if ($_POST['lugarentrega']) update_post_meta( $order_id, 'lugarentrega', esc_attr($_POST['lugarentrega']));
...
function wps_select_checkout_field_display_admin_order_meta($order){
        echo '<br><p><strong>'.__('Lugar de entrega').':</strong> ' . get_post_meta( $order->id, 'lugarentrega', true ) . '</p>';
}
...
function wps_select_order_meta_keys( $keys ) {
       ...
       $keys['Lugar de entrega'] = 'lugarentrega';
       return $keys;
